    ...
    while( !node.isNull() ) {
        ...
        if( !element.isNull() ) { // was really an element
            ...
            if( tagName == "Type" ) {
                ...
                qDebug( "Unknown subelement of AxisSettings found: %s", tagName.toLatin1() );
            }
        }
                ...
                while( !node.isNull() ) {
                    ...
                    if( !element.isNull() ) { // was really an element
                        ...
                        if( tagName == "Dataset" ) {
                            ...
                            qDebug( "Unknown subelement of ModeAndChartMap found: %s", tagName.toLatin1() );
                        }
                    }
                    node = node.nextSibling();
                }
                ...
                while( !node.isNull() ) {
                    ...
                    if( !element.isNull() ) { // was really an element
                        ...
                        if( tagName == "DataColors" ) {
                            ...
                            qDebug( "!!!Unknown subelement of ColorSettings found: %s", tagName.toLatin1() );
                        }
                    }
                    node = node.nextSibling();
                }
                ...
                while( !node.isNull() ) {
                    ...
                    if( !element.isNull() ) { // was really an element
                        ...
                        if( tagName == "SubType" ) {
                            ...
                            qDebug( "Unknown subelement of BarSettings found: %s", tagName.toLatin1() );
                        }
                    }
                    node = node.nextSibling();
                }
                ...
                while( !node.isNull() ) {
                    ...
                    if( !element.isNull() ) { // was really an element
                        ...
                        if( tagName == "SubType" ) {
                            ...
                            qDebug( "Unknown subelement of LineSettings found: %s", tagName.toLatin1() );
                        }
                    }
                    node = node.nextSibling();
                }
                ...
                while( !node.isNull() ) {
                    ...
                    if( !element.isNull() ) { // was really an element
                        ...
                        if( tagName == "SubType" ) {
                            ...
                            qDebug( "Unknown subelement of AreaSettings found: %s", tagName.toLatin1() );
                        }
                    }
                    node = node.nextSibling();
                }
                ...
                while( !node.isNull() ) {
                    ...
                    if( !element.isNull() ) { // was really an element
                        ...
                        if( tagName == "Explode" ) {
                            ...
                            qDebug( "Unknown subelement of PieRingSettings found: %s", tagName.toLatin1() );
                        }
                    }
                    node = node.nextSibling();
                }
                ...
                while( !node.isNull() ) {
                    ...
                    if( !element.isNull() ) { // was really an element
                        ...
                        if( tagName == "SubType" ) {
                            ...
                            qDebug( "Unknown subelement of HiLoSettings found: %s", tagName.toLatin1() );
                        }
                    }
                    node = node.nextSibling();
                }
                                ...
                                while( !node.isNull() ) {
                                    ...
                                    if( !element.isNull() ) { // was really an element
                                        ...
                                        if( tagName == "Active" ) {
                                            ...
                                            qDebug( "Unknown subelement of BoxAndWhiskerSettings found: %s", tagName.toLatin1() );
                                        }
                                    }
                                }
                            } else {
                ...
                while( !node.isNull() ) {
                    ...
                    if( !element.isNull() ) { // was really an element
                        ...
                        if( tagName == "SubType" ) {
                            ...
                            qDebug( "Unknown subelement of PolarSettings found: %s", tagName.toLatin1() );
                        }
                    }
                    node = node.nextSibling();
                }
                ...
                while( !node.isNull() ) {
                    ...
                    if( !element.isNull() ) { // was really an element
                        ...
                        if( tagName == "Position" ) {
                            ...
                            qDebug( "Unknown subelement of LegendSettings found: %s", tagName.toLatin1() );
                        }
                    }
                    node = node.nextSibling();
                }
                ...
                while( !node.isNull() ) {
                    ...
                    if( !element.isNull() ) { // was really an element
                        ...
                        if( tagName == "Text" ) {
                            ...
                            qDebug( "Unknown subelement of HeaderFooterSettings found: %s", tagName.toLatin1() );
                        }
                    }
                    node = node.nextSibling();
                }
                ...
                while( !node.isNull() ) {
                    ...
                    if( !element.isNull() ) { // was really an elemente
                        ...
                        if( tagName == "Left" ) {
                            ...
                            qDebug( "Unknown subelement of GlobalLeading found: %s", tagName.toLatin1() );
                        }
                    }
                    node = node.nextSibling();
                }
                ...
                while( !node.isNull() ) {
                    ...
                    if( !element.isNull() ) { // was really an element
                        ...
                        if( tagName == "PrintDataValues" ) {
                            ...
                            qDebug( "Unknown subelement of DataValuesSettings1 found: %s", tagName.toLatin1() );
                        }
                    }
                    node = node.nextSibling();
                }
                ...
                while( !node.isNull() ) {
                    ...
                    if( !element.isNull() ) { // was really an element
                        ...
                        if( tagName == "PrintDataValues" ) {
                            ...
                            qDebug( "Unknown subelement of DataValuesSettings2 found: %s", tagName.toLatin1() );
                        }
                    }
                    node = node.nextSibling();
                }
                ...
                while( !node.isNull() ) {
                    ...
                    if( !element.isNull() ) { // was really an element
                        ...
                        if( tagName == "allowOverlappingTexts" ) {
                            ...
                            qDebug( "Unknown subelement of DataValuesGlobalSettings found: %s", tagName.toLatin1() );
                ...
                while( !node.isNull() ) {
                    ...
                    if( !element.isNull() ) { // was really an element
                        ...
                        if( tagName == "FrameSettings" ) {
                            ...
                            qDebug( "Unknown tag in AreaMap found: %s", tagName.toLatin1() );
                        // do _not_ return false here (to enable future extentions)
                    }
                    node = node.nextSibling();
                }
                ...
                while( !node.isNull() ) {
                    ...
                    if( !element.isNull() ) { // was really an element
                        ...
                        if( tagName == "Number" ) {
                            ...
                            qDebug( "Unknown tag in CustomBoxMap found: %s", tagName.toLatin1() );
                    }
                    node = node.nextSibling();
                }
            } else {
