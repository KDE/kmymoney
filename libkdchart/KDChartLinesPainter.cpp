                                             ...
                                             uint datasetEnd )
{
                ...
                if( !skipMe ){
                    ...
                    if( !skipMe ){
                        ...
                        if( cellPropID != curPropSetId ){
                            ...
                            //qDebug(curPropSet.name().toLatin1());
    ...
    //qDebug(const_cast < KDChartParams* > ( params() )->properties( KDCHART_PROPSET_NORMAL_DATA )->name().toLatin1());
    //qDebug(const_cast < KDChartParams* > ( params() )->properties( KDCHART_PROPSET_TRANSPARENT_DATA )->name().toLatin1());
    //qDebug(const_cast < KDChartParams* > ( params() )->properties( KDCHART_PROPSET_HORI_LINE )->name().toLatin1());
    //qDebug(const_cast < KDChartParams* > ( params() )->properties( KDCHART_PROPSET_VERT_LINE )->name().toLatin1());
    //qDebug("--");
    }
