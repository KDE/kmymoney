                                ...
                                if ( cellValue < 0 || cellValue < minColumnValue ) {
                                    ...
                                    if ( tooLow && ( bNormalMode || bMultiRows) ) {
                                        ...
                                        /*
                                          ...
                                          qDebug( "value %s",QString::number(static_cast <int> (cellValue)).toLatin1());
                                          qDebug( "pt1Y %s", QString::number(static_cast <int> (cellValue * pixelsPerUnit * -2)).toLatin1());
                                          }
                                          else
                                    ...
                                    //qDebug( "yZero %s", QString::number( yZero ).toLatin1());
                                    //qDebug( "minDataValueYPos = %s",  QString::number( minDataValueYPos).toLatin1());
                                    //qDebug( "positive value %s",  QString::number( cellValue).toLatin1());
                                    ...
                                    if ( tooHigh && bNormalMode ||
                                        ...
                                        if( bDrawExtraLines ){
                                            ...
                                            if( 1.5 > frontBarWidth ){
                                                ...
                                                /*
                                                  painter->drawText( rect.topLeft(), QString::number(cellValue).toLatin1());
