    ...
    , d_ptr(new KTagContainerPrivate(this))
{
    ...
    connect(d->m_tagCombo, QOverload<int>::of(&QComboBox::currentIndexChanged), this, [this](int row) {
        Q_D(KTagContainer);
    ...
    connect(d->m_tagCombo, QOverload<int>::of(&QComboBox::activated), this, [this](int row) {
        Q_D(KTagContainer);
