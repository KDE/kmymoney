...
void MyMoneyAccountTest::amountType_data()
{
  QTest::addColumn<MyMoneyAccount::accountTypeE>("accountType");
  QTest::addColumn<QString>("value");
  QTest::addColumn<MyMoneyAccount::amountTypeE>("result");

  // positive and null is debit
  QTest::newRow("unknown-pos") << MyMoneyAccount::UnknownAccountType << "10/1" << MyMoneyAccount::amountTypeDebit;
  QTest::newRow("unknown-null") << MyMoneyAccount::UnknownAccountType << "0/1" << MyMoneyAccount::amountTypeDebit;
  QTest::newRow("unknown-neg") << MyMoneyAccount::UnknownAccountType << "-10/1" << MyMoneyAccount::amountTypeCredit;

  QTest::newRow("checking-pos") << MyMoneyAccount::Checkings << "10/1" << MyMoneyAccount::amountTypeDebit;
  QTest::newRow("checking-null") << MyMoneyAccount::Checkings << "0/1" << MyMoneyAccount::amountTypeDebit;
  QTest::newRow("checking-neg") << MyMoneyAccount::Checkings << "-10/1" << MyMoneyAccount::amountTypeCredit;

  QTest::newRow("savings-pos") << MyMoneyAccount::Savings << "10/1" << MyMoneyAccount::amountTypeDebit;
  QTest::newRow("savings-null") << MyMoneyAccount::Savings << "0/1" << MyMoneyAccount::amountTypeDebit;
  QTest::newRow("savings-neg") << MyMoneyAccount::Savings << "-10/1" << MyMoneyAccount::amountTypeCredit;

  QTest::newRow("cash-pos") << MyMoneyAccount::Cash << "10/1" << MyMoneyAccount::amountTypeDebit;
  QTest::newRow("cash-null") << MyMoneyAccount::Cash << "0/1" << MyMoneyAccount::amountTypeDebit;
  QTest::newRow("cash-neg") << MyMoneyAccount::Cash << "-10/1" << MyMoneyAccount::amountTypeCredit;

  QTest::newRow("investment-pos") << MyMoneyAccount::Investment << "10/1" << MyMoneyAccount::amountTypeDebit;
  QTest::newRow("investment-null") << MyMoneyAccount::Investment << "0/1" << MyMoneyAccount::amountTypeDebit;
  QTest::newRow("investment-neg") << MyMoneyAccount::Investment << "-10/1" << MyMoneyAccount::amountTypeCredit;

  QTest::newRow("asset-pos") << MyMoneyAccount::Asset << "10/1" << MyMoneyAccount::amountTypeDebit;
  QTest::newRow("asset-null") << MyMoneyAccount::Asset << "0/1" << MyMoneyAccount::amountTypeDebit;
  QTest::newRow("asset-neg") << MyMoneyAccount::Asset << "-10/1" << MyMoneyAccount::amountTypeCredit;

  QTest::newRow("currency-pos") << MyMoneyAccount::Currency << "10/1" << MyMoneyAccount::amountTypeDebit;
  QTest::newRow("currency-null") << MyMoneyAccount::Currency << "0/1" << MyMoneyAccount::amountTypeDebit;
  QTest::newRow("currency-neg") << MyMoneyAccount::Currency << "-10/1" << MyMoneyAccount::amountTypeCredit;

  QTest::newRow("expense-pos") << MyMoneyAccount::Expense << "10/1" << MyMoneyAccount::amountTypeDebit;
  QTest::newRow("expense-null") << MyMoneyAccount::Expense << "0/1" << MyMoneyAccount::amountTypeDebit;
  QTest::newRow("expense-neg") << MyMoneyAccount::Expense << "-10/1" << MyMoneyAccount::amountTypeCredit;

  QTest::newRow("moneymarket-pos") << MyMoneyAccount::MoneyMarket << "10/1" << MyMoneyAccount::amountTypeDebit;
  QTest::newRow("moneymarket-null") << MyMoneyAccount::MoneyMarket << "0/1" << MyMoneyAccount::amountTypeDebit;
  QTest::newRow("moneymarket-neg") << MyMoneyAccount::MoneyMarket << "-10/1" << MyMoneyAccount::amountTypeCredit;

  QTest::newRow("certificatedeposit-pos") << MyMoneyAccount::CertificateDep << "10/1" << MyMoneyAccount::amountTypeDebit;
  QTest::newRow("certificatedeposit-null") << MyMoneyAccount::CertificateDep << "0/1" << MyMoneyAccount::amountTypeDebit;
  QTest::newRow("certificatedeposit-neg") << MyMoneyAccount::CertificateDep << "-10/1" << MyMoneyAccount::amountTypeCredit;

  QTest::newRow("assetloan-pos") << MyMoneyAccount::AssetLoan << "10/1" << MyMoneyAccount::amountTypeDebit;
  QTest::newRow("assetloan-null") << MyMoneyAccount::AssetLoan << "0/1" << MyMoneyAccount::amountTypeDebit;
  QTest::newRow("assetloan-neg") << MyMoneyAccount::AssetLoan << "-10/1" << MyMoneyAccount::amountTypeCredit;

  QTest::newRow("stock-pos") << MyMoneyAccount::Stock << "10/1" << MyMoneyAccount::amountTypeDebit;
  QTest::newRow("stock-null") << MyMoneyAccount::Stock << "0/1" << MyMoneyAccount::amountTypeDebit;
  QTest::newRow("stock-neg") << MyMoneyAccount::Stock << "-10/1" << MyMoneyAccount::amountTypeCredit;

  // positive and null is credit
  QTest::newRow("creditcard-pos") << MyMoneyAccount::CreditCard << "10/1" << MyMoneyAccount::amountTypeCredit;
  QTest::newRow("creditcard-null") << MyMoneyAccount::CreditCard << "0/1" << MyMoneyAccount::amountTypeCredit;
  QTest::newRow("creditcard-neg") << MyMoneyAccount::CreditCard << "-10/1" << MyMoneyAccount::amountTypeDebit;

  QTest::newRow("loan-pos") << MyMoneyAccount::Loan << "10/1" << MyMoneyAccount::amountTypeCredit;
  QTest::newRow("loan-null") << MyMoneyAccount::Loan << "0/1" << MyMoneyAccount::amountTypeCredit;
  QTest::newRow("loan-neg") << MyMoneyAccount::Loan << "-10/1" << MyMoneyAccount::amountTypeDebit;

  QTest::newRow("liability-pos") << MyMoneyAccount::Liability << "10/1" << MyMoneyAccount::amountTypeCredit;
  QTest::newRow("liability-null") << MyMoneyAccount::Liability << "0/1" << MyMoneyAccount::amountTypeCredit;
  QTest::newRow("liability-neg") << MyMoneyAccount::Liability << "-10/1" << MyMoneyAccount::amountTypeDebit;

  QTest::newRow("income-pos") << MyMoneyAccount::Income << "10/1" << MyMoneyAccount::amountTypeCredit;
  QTest::newRow("income-null") << MyMoneyAccount::Income << "0/1" << MyMoneyAccount::amountTypeCredit;
  QTest::newRow("income-neg") << MyMoneyAccount::Income << "-10/1" << MyMoneyAccount::amountTypeDebit;

  QTest::newRow("equity-pos") << MyMoneyAccount::Equity << "10/1" << MyMoneyAccount::amountTypeCredit;
  QTest::newRow("equity-null") << MyMoneyAccount::Equity << "0/1" << MyMoneyAccount::amountTypeCredit;
  QTest::newRow("equity-neg") << MyMoneyAccount::Equity << "-10/1" << MyMoneyAccount::amountTypeDebit;
}

void MyMoneyAccountTest::amountType()
{
  QFETCH(MyMoneyAccount::accountTypeE, accountType);
  QFETCH(QString, value);
  QFETCH(MyMoneyAccount::amountTypeE, result);

  MyMoneyAccount a;
  a.setAccountType(accountType);
  QCOMPARE(a.amountType(MyMoneyMoney(value)), result);
}
