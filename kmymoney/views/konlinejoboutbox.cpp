...
void KOnlineJobOutbox::init()
{
  ...
  connect(pActions[eMenu::Action::AccountCreditTransfer], &QAction::changed, this, &KOnlineJobOutbox::updateNewCreditTransferButton);
...
void KOnlineJobOutbox::updateButtonState() const
{
  ...
  QAction *const onlinejob_edit = pActions[eMenu::Action::OnlineJobEdit];
  ...
  QAction *const onlinejob_delete = pActions[eMenu::Action::OnlineJobDelete];
...
{
  QAction* action = pActions[eMenu::Action::AccountCreditTransfer];
  Q_CHECK_PTR(action);
