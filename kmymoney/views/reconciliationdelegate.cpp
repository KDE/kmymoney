...
QColor ReconciliationDelegate::m_erroneousColor = QColor(Qt::red);
QColor ReconciliationDelegate::m_importedColor = QColor(Qt::yellow);
QColor ReconciliationDelegate::m_separatorColor = QColor(0xff, 0xf2, 0x9b);
...
ReconciliationDelegate::ReconciliationDelegate(LedgerView* parent)
...
void ReconciliationDelegate::setErroneousColor(const QColor& color)
{
