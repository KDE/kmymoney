    ...
    KMyMoneyViewBase(*new KGlobalLedgerViewPrivate(this), parent)
{
    const QHash<Action, std::function<void()>> actionConnections {
        {Action::NewTransaction,            [this]() {
                KGlobalLedgerView::slotNewTransaction();
            }
        },
        {Action::EditTransaction,           [this]() {
                KGlobalLedgerView::slotEditTransaction();
            }
        },
        {Action::DeleteTransaction,         [this]() {
                KGlobalLedgerView::slotDeleteTransaction();
            }
        },
        {Action::DuplicateTransaction,      [this]() {
                KGlobalLedgerView::slotDuplicateTransaction();
            }
        },
        {Action::AddReversingTransaction,   [this]() {
                KGlobalLedgerView::slotDuplicateTransaction(true);
            }
        },
        {Action::EnterTransaction,          [this]() {
                KGlobalLedgerView::slotEnterTransaction();
            }
        },
        {Action::AcceptTransaction,         [this]() {
                KGlobalLedgerView::slotAcceptTransaction();
            }
        },
        {Action::CancelTransaction,         [this]() {
                KGlobalLedgerView::slotCancelTransaction();
            }
        },
        {Action::EditSplits,                [this]() {
                KGlobalLedgerView::slotEditSplits();
            }
        },
        {Action::CopySplits,                [this]() {
                KGlobalLedgerView::slotCopySplits();
            }
        },
        {Action::MatchTransaction,          [this]() {
                KGlobalLedgerView::slotMatchTransactions();
            }
        },
        {Action::CombineTransactions,       [this]() {
                KGlobalLedgerView::slotCombineTransactions();
            }
        },
        {Action::ToggleReconciliationFlag,  [this]() {
                KGlobalLedgerView::slotToggleReconciliationFlag();
            }
        },
        {Action::MarkCleared,               [this]() {
                KGlobalLedgerView::slotMarkCleared();
            }
        },
        {Action::MarkReconciled,            [this]() {
                KGlobalLedgerView::slotMarkReconciled();
            }
        },
        {Action::MarkNotReconciled,         [this]() {
                KGlobalLedgerView::slotMarkNotReconciled();
            }
        },
        {Action::SelectAllTransactions,     [this]() {
                KGlobalLedgerView::slotSelectAllTransactions();
            }
        },
        {Action::NewScheduledTransaction,   [this]() {
                KGlobalLedgerView::slotCreateScheduledTransaction();
            }
        },
        {Action::AssignTransactionsNumber,  [this]() {
                KGlobalLedgerView::slotAssignNumber();
            }
        },
        {Action::StartReconciliation,       [this]() {
                KGlobalLedgerView::slotStartReconciliation();
            }
        },
        {Action::FinishReconciliation,      [this]() {
                KGlobalLedgerView::slotFinishReconciliation();
            }
        },
        {Action::PostponeReconciliation,    [this]() {
                KGlobalLedgerView::slotPostponeReconciliation();
            }
        },
        {Action::OpenAccount,               [this]() {
                KGlobalLedgerView::slotOpenAccount();
            }
        },
        {Action::EditFindTransaction,       [this]() {
                KGlobalLedgerView::slotFindTransaction();
            }
        },
    };
