    ...
    , ui(new Ui::PaymentFrequencyWizardPage)
{
    ...
    ui->m_paymentFrequencyUnitEdit->setCurrentIndex(
        ui->m_paymentFrequencyUnitEdit->findData(QVariant((int)eMyMoney::Schedule::Occurrence::Monthly), Qt::UserRole, Qt::MatchExactly));
}
