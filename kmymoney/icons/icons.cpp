...
const QHash<Icon, QHash<IconSet, QString>> iconMappings{
    ...
    {Icon::Bank, {{IconSet::Common, QStringLiteral("bank")}, {IconSet::Oxygen, QStringLiteral("view-bank")}, {IconSet::Breeze, QStringLiteral("view-bank")}}},
    {Icon::BankAccount,
     {{IconSet::Common, QStringLiteral("account")},
      {IconSet::Oxygen, QStringLiteral("view-bank-account")},
    ...
    {Icon::Transaction, {{IconSet::Common, QStringLiteral("ledger")}, {IconSet::Oxygen, QStringLiteral("view-financial-transfer")}}},
    {Icon::Forecast,
