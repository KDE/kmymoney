...
namespace Icons {
  ...
  const QHash<Icon, iconDescription> sComposedIcons {
    ...
    {Icon::ToolUpdatePrices,            {Icon::ViewInvestments, Icon::Download, Qt::BottomRightCorner}},
    ...
    {Icon::InvestmentNew,               {Icon::ViewInvestments, Icon::ListAdd, Qt::TopRightCorner}},
    {Icon::InvestmentEdit,              {Icon::ViewInvestments, Icon::DocumentEdit, Qt::BottomRightCorner}},
    {Icon::InvestmentDelete,            {Icon::ViewInvestments, Icon::EditDelete, Qt::BottomRightCorner}},
    {Icon::InvestmentOnlinePrice,       {Icon::ViewInvestments, Icon::Download, Qt::BottomRightCorner}},
  ...
  QHash<Icon, QString> getCommonNames()
  {
    return {
      ...
      {Icon::UnmapOnlineAccount, QStringLiteral("news-unsubscribe")},
      {Icon::MapOnlineAccount, QStringLiteral("news-subscribe")},
      ...
      {Icon::PerformanceTest, QStringLiteral("fork")},
      ...
      {Icon::ViewInvestments, QStringLiteral("investment")},
      ...
      {Icon::Budget, QStringLiteral("budget")},
      ...
      {Icon::OpenDatabase, QStringLiteral("svn-update")},
      ...
      {Icon::Reconciled, QStringLiteral("reconciled")},
      ...
      {Icon::Report, QStringLiteral("application-vnd.oasis.opendocument.spreadsheet")},
      ...
      {Icon::PreferencesGeneral, QStringLiteral("system-run")},
      ...
      {Icon::PreferencesPlugin, QStringLiteral("network-disconnect")},
  ...
  QHash<Icon, QString> getKDENames()
  {
    return {
      ...
      {Icon::Budget, QStringLiteral("view-time-schedule-calculus")},
      ...
      {Icon::Reconciled, QStringLiteral("flag-green")},
  ...
  QHash<Icon, QString> getOxygenNames()
  {
    return {
      ...
      {Icon::ViewInvestments, QStringLiteral("view-investment")},
  ...
  QHash<Icon, QString> getTangoNames()
  {
    return {
      ...
      {Icon::PreferencesGeneral, QStringLiteral("media-playback-start")},
