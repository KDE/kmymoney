    ...
    : QWidget(parent)
{
    ...
    connect(kcfg_checkTemplateFile, &KUrlRequester::urlSelected, this, QOverload<const QUrl&>::of(&CheckPrintingSettingsWidget::urlSelected));
    ...
    connect(kcfg_useCustomCheckTemplate, &QCheckBox::toggled, this, QOverload<>::of(&CheckPrintingSettingsWidget::urlSelected));
}
