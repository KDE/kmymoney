...
#ifndef TASKCONVERTERSEPATOGERMAN_H
#define TASKCONVERTERSEPATOGERMAN_H

#include <onlinetasks/interfaces/converter/onlinetaskconverter.h>

class taskConverterSepaToGerman : public onlineTaskConverter
{
public:
...
#endif // TASKCONVERTERSEPATOGERMAN_H
