{
    "KPlugin": {
        ...
        "Description[ar]": "إن جرت مطابقتها مع حساب، فهي تدّعي أن بإمكانها معالجة كل المهام عبر الإنترنت (للمطورين فقط).",
        ...
        "Description[eo]": "Se mapite al konto, ĝi ŝajnigas, ke ĝi povus pritrakti ĉiujn retajn Taskojn (nur por programistoj).",
        ...
        "Description[ga]": "Má mhapáiltear chuig cuntas é, ligeann sé air go bhféadfadh sé gach tasc ar líne a láimhseáil (d'fhorbróirí amháin).",
        "Description[gl]": "Se está asociado cunha conta pretende que pode xestionar todas as onlineTasks (só para desenvolvedores).",
        "Description[he]": "אם ממופה לחשבון, הוא מעמיד פנים שהוא יכול לטפל בכל ה־onlineTasks (משימות מקוונות) - למפתחים בלבד.",
        ...
        "Description[lo]": "ຖ້າຫາກເຊື່ອມໂຍງກັບບັນຊີ, ມັນຈະທຳທ່າວ່າສາມາດຈັດການວຽກອອນລາຍທັງໝົດໄດ້ (ສຳລັບນັກພັດທະນາເທົ່ານັ້ນ).",
        "Description[nb]": "Dersom denne er tilordnet en konto vil den late som at den kan håndtere alle nettbaserte oppgaver (kun for utviklere).",
        ...
        "Description[tr]": "Bir hesapla eşlenirse tüm çevrim içi görevleri halledebilirmiş gibi görünür (yalnızca geliştiriciler için).",
        ...
        "Name[eo]": "enrettaskakromprogramimito",
        ...
        "Name[ga]": "breiseán poist ar líne samhail",
        "Name[gl]": "onlinejobpluginmockup",
        "Name[he]": "onlinejobpluginmockup",
        "Name[it]": "onlinejobpluginmockup",
        "Name[ka]": "onlinejobpluginmockup",
        "Name[ko]": "onlinejobpluginmockup",
        "Name[lo]": "ແບບຈຳລອງປັກອິນວຽກອອນລາຍ",
        "Name[nb]": "onlinejobpluginmockup",
        ...
        "Name[tr]": "çevrim-içi-iş-eklenti-maketi",
