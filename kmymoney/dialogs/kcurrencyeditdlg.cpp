    ...
    , d_ptr(new KCurrencyEditDlgPrivate(this))
{
    ...
    connect(d->ui->m_currencyList,
            ...
            this,
            static_cast<void (KCurrencyEditDlg::*)(QTreeWidgetItem*, int)>(&KCurrencyEditDlg::slotUpdateCurrency));
...
void KCurrencyEditDlg::slotLoadCurrencies()
{
    ...
    disconnect(d->ui->m_currencyList,
               ...
               this,
               static_cast<void (KCurrencyEditDlg::*)(QTreeWidgetItem*, QTreeWidgetItem*)>(&KCurrencyEditDlg::slotSelectCurrency));
    disconnect(d->ui->m_currencyList,
               &QTreeWidget::itemChanged,
               this,
               static_cast<void (KCurrencyEditDlg::*)(QTreeWidgetItem*, int)>(&KCurrencyEditDlg::slotUpdateCurrency));
